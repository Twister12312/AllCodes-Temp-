...
@Component({
  selector: 'app-adm-schd-home',
  templateUrl: './adm-schd-home.component.html',
  styleUrls: ['./adm-schd-home.component.css']
})
export class AdmSchdHomeComponent implements OnInit {
  ...
  onSubmit(form:any){
    ...
    View(eid:any){
      this.route.navigate([`/admschdhome/${eid}`],eid);
